...
from app.schemas.auth import RegisterRequest, LoginRequest, TokenResponse, UserOut, InviteUserRequest
...
async def invite_user(
    ...
    return await auth_service.invite_user(data, current_user.tenant_id, db)
